...
var myBarChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      ...
      borderColor: "#4e73df",
      <?php
      $tuteeSQL = "SELECT count(*)'count' FROM `tutee`;";
      $tuteeResult = mysqli_query($db, $tuteeSQL);
      $tuteeCount = $tuteeResult->fetch_assoc()['count'];

      $tutorSQL = "SELECT count(*)'count' FROM `tutor`;";
      $tutorResult = mysqli_query($db, $tutorSQL);
      $tutorCount = $tutorResult->fetch_assoc()['count'];
      ?>
      data: [<?php echo $tutorCount?>, <?php echo $tuteeCount?>],
    }],
  },
  options: {
