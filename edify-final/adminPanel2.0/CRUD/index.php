...
$sql ="select * from task"; //write the query
			...
			<div class="row" style="margin-top: 70px;">
				...
				<div class="col-md-10 col-md-offset-1" > <!-- Task 2 -->
					<table class="table">
						...
						<button type="button" data-target="#myModal" data-toggle="modal" class="btn btn-success"> Add Tasks Button</button>  <!-- Task 2 --> <!-- Task 4 : Data Target-->
							  ...
							  <div class="modal-dialog">
							    ...
							    <div class="modal-content">
							      <div class="modal-header">
							        ...
							        <h4 class="modal-title">Add Task</h4> <!-- Task 5: Add tasks title changed -->
							      </div>
						...
						<tbody> <!-- Step 8: tbody will be used for displaying the data -->
							<tr>
								...
								?>
								<th scope="row"><?php echo $row['id'] ?></th> <!-- Task 8 Print from Database -->
								<td class="col-md-10"><?php echo $row['name'] ?></td>  <!-- Task 3 -->
								<td><a href="update.php?id=<?php echo $row['id'];?>" class="btn btn-success">Edit</td> <!-- Task 3 -->
									<td><a href="delete.php?id=<?php echo $row['id'];?>" class="btn btn-danger">Delete</td>  <!-- Task 3 -->
							</tr>
